// app/components/employee/EmployeeEditForm.tsx

'use client';

import { useState, FormEvent } from 'react';
import { POSITIONS, Position } from '@/app/types/position';
...
export default function EmployeeEditForm({ employee, departments, onUpdate }: EmployeeEditFormProps) {
